...
Projeto Maven independente, Java 21+. Abra o pom.xml no IntelliJ e execute org.claujunior.contacorrente.App.

## Executar localmente

    mvn package
    java -jar target/conta-corrente-service-1.0-SNAPSHOT.jar 127.0.0.2 9090

Sem argumentos, usa 127.0.0.2:9090. UDP_BIND_HOST tambem configura o IP; o primeiro argumento tem prioridade.
